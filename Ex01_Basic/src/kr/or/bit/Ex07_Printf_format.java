...
public class Ex07_Printf_format {
	public static void main(String[] args) {
		...
		System.out.println("A");// 객체지향 기법 오버로딩
		System.out.print("B");
		System.out.print("C");
		...
		//format 형식 문자
		// %d (10진수 형식의 정수) >> ㅇ라는 자리에
		// %f(실수)
		// %s (문자열)
		// %c (문자)
		// 특수문자 : \t (tab), \n (줄바꿈)
		System.out.printf("num 값은 [%d] 입니다 그리고 [%d] 도 있어요", num, 1000);
		
		float f = 3.14f;
		System.out.println(f);
		System.out.printf("변수값은 %f 입니다 \n", f); //f 변수값은 3.140000 입니다
		...
		String value = sc.nextLine(); // 대기상태 nextLine() 당신이 입력한 값을 문자열로 전달
		System.out.println("입력값 :" + value);
		
		int number = sc.nextInt();//정수값을 읽어서 리턴하겠습니다
		System.out.println("정수값: " + number);
		*/
		//sc.nextFloat(); 실수값 읽기
		//권장 사항: nextInt, nextFloat 함수보다는 nextLine() 을 사용하자
		//Today point
		//[문자를 -> 숫자로 바꾸기]
